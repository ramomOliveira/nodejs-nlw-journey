/*
  ...
  - You are about to drop the column `tiltle` on the `activities` table. All the data in the column will be lost.
...
INSERT INTO "new_activities" ("accours_at", "id", "trip_id") SELECT "accours_at", "id", "trip_id" FROM "activities";
